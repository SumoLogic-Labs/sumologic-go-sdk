...
/*
ListSources
Gets information about all Sources for a specified Collector. To get specific information about a source use the
specific source Get function.
*/
func (a *APIClient) ListSources(collectorId string) (types.ListSourcesResponse, *http.Response, error) {
	var (
		...
		localVarReturnValue types.ListSourcesResponse
	)
	...
	if localVarHttpResponse.StatusCode < 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v types.ListSourcesResponse
