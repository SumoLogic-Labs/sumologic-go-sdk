...
*/
func (a *APIClient) BeginDashboardAsyncImport(body types.DashboardSyncDefinition, folderId string, localVarOptionals *types.ContentManagementApiBeginAsyncImportOpts) (types.BeginAsyncJobResponse, *http.Response, error) {
	var (
