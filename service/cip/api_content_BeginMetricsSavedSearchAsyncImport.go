...
*/
func (a *APIClient) BeginMetricsSavedSearchAsyncImport(body types.MetricsSavedSearchSyncDefinition, folderId string, localVarOptionals *types.ContentManagementApiBeginAsyncImportOpts) (types.BeginAsyncJobResponse, *http.Response, error) {
	var (
