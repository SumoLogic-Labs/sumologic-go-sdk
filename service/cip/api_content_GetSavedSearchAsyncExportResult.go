...
Returns types.SavedSearchWithScheduleSyncDefinition
*/
func (a *APIClient) GetSavedSearchAsyncExportResult(contentId string, jobId string, localVarOptionals *types.ContentManagementApiGetAsyncExportResultOpts) (types.SavedSearchWithScheduleSyncDefinition, *http.Response, error) {
	var (
