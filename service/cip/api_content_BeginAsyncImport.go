...
*/
func (a *APIClient) BeginAsyncImport(body types.ContentSyncDefinition, folderId string, localVarOptionals *types.ContentManagementApiBeginAsyncImportOpts) (types.BeginAsyncJobResponse, *http.Response, error) {
	var (
