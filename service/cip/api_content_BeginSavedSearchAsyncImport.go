...
*/
func (a *APIClient) BeginSavedSearchAsyncImport(body types.SavedSearchWithScheduleSyncDefinition, folderId string, localVarOptionals *types.ContentManagementApiBeginAsyncImportOpts) (types.BeginAsyncJobResponse, *http.Response, error) {
	var (
