...
type AWSS3ArchiveResponseModel struct {
...
type AWSS3ArchiveDefinition struct {
	ApiVersion string       `json:"api.version"`
	Source     AWSS3Archive `json:"source"`
}

type AWSS3ArchiveResponse struct {
	Source AWSS3ArchiveResponseModel `json:"source"`
}
