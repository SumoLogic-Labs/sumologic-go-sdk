...
Returns types.DashboardSyncDefinition
*/
func (a *APIClient) GetDashboardAsyncExportResult(contentId string, jobId string, localVarOptionals *types.ContentManagementApiGetAsyncExportResultOpts) (types.DashboardSyncDefinition, *http.Response, error) {
	var (
