...
*/
func (a *APIClient) BeginLookupTableAsyncImport(body types.LookupTableSyncDefinition, folderId string, localVarOptionals *types.ContentManagementApiBeginAsyncImportOpts) (types.BeginAsyncJobResponse, *http.Response, error) {
	var (
