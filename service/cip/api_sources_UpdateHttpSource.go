...
/*
UpdateHttpSource
Update a Http source.
	body - The definition of the Http source.
...
*/
func (a *APIClient) UpdateHttpSource(body types.UpdateHttpSourceRequest, collectorId string, sourceId string) (types.HttpSourceModel, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Put")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue types.HttpSourceModel
	)
	...
	etag, err := a.getHttpSourceEtag(localVarPath)
	if err != nil {
...
func (a *APIClient) getHttpSourceEtag(path string) ([]string, error) {
	var (
