...
Returns types.LookupTableSyncDefinition
*/
func (a *APIClient) GetLookupTableAsyncExportResult(contentId string, jobId string, localVarOptionals *types.ContentManagementApiGetAsyncExportResultOpts) (types.LookupTableSyncDefinition, *http.Response, error) {
	var (
