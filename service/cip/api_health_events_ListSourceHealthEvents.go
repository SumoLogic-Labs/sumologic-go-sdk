...
Get a list of unresolved source health events in your account that belong to the supplied resource identifiers.
...
*/
func (a *APIClient) ListSourceHealthEvents(body types.SourceIdentities, localVarOptionals *types.HealthEventsOpts) (types.ListHealthEventResponse, *http.Response, error) {
	var (
